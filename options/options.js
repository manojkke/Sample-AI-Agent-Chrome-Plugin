...
document.getElementById("optionsTitle").innerHTML =
  chrome.i18n.getMessage("optionsTitle");

// localize api title apiTitle
document.getElementById("apiTitle").innerHTML =
  chrome.i18n.getMessage("apiTitle");

// localize the api key input placeholder
document.getElementById("apiKey").placeholder = chrome.i18n.getMessage(
  "optionsInputPlaceholder"
);

// localize api-key-note
document.getElementById("api-key-note").innerHTML =
  chrome.i18n.getMessage("optionsApiKeyNote");

// localize save button text
document.getElementById("save-button-text").innerText = chrome.i18n.getMessage(
  "optionsSaveButtonText"
);

// localize delete button text
document.getElementById("delete-button-text").innerText =
  chrome.i18n.getMessage("optionsDeleteButtonText");
